...
static inline int64_t compute_sum(int64_t a, int64_t b);
int main(int argc, char** argv);


#line 2 "temp_adv_prog.end"
static inline int64_t compute_sum(int64_t a, int64_t b) {
    #line 3 "temp_adv_prog.end"
    int64_t total __attribute__((unused)) = (a + b);
    #line 4 "temp_adv_prog.end"
    return total;
    return 0;
}

#line 7 "temp_adv_prog.end"
int main(int argc, char** argv) {
    (void)argc; (void)argv;
    #line 8 "temp_adv_prog.end"
    int64_t s __attribute__((unused)) = compute_sum(10, 20);
    #line 9 "temp_adv_prog.end"
    end_println(s);
    return 0;
}
