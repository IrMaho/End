...
impl Parser {
    pub fn parse_identifier_or_keyword(&mut self) -> Result<String, String> {
        ...
        match tok.kind {
            ...
            TokenKind::Inherits => Ok("inherits".to_string()),
            TokenKind::Inherit => Ok("inherit".to_string()),
            TokenKind::Abstract => Ok("abstract".to_string()),
            TokenKind::Super => Ok("super".to_string()),
            TokenKind::SuperChain => Ok("superchain".to_string()),
            TokenKind::Conflict => Ok("conflict".to_string()),
            TokenKind::Virtual => Ok("virtual".to_string()),
            TokenKind::Share => Ok("share".to_string()),
            TokenKind::Except => Ok("except".to_string()),
            TokenKind::Delegates => Ok("delegates".to_string()),
            TokenKind::Delegation => Ok("delegation".to_string()),
            TokenKind::Contractually => Ok("contractually".to_string()),
            TokenKind::Over => Ok("over".to_string()),
            TokenKind::Without => Ok("without".to_string()),
            TokenKind::Inspect => Ok("inspect".to_string()),
            TokenKind::Behavior => Ok("behavior".to_string()),
            TokenKind::Capabilities => Ok("capabilities".to_string()),
            TokenKind::Permissions => Ok("permissions".to_string()),
            TokenKind::Permission => Ok("permission".to_string()),
            TokenKind::Events => Ok("events".to_string()),
            ...
            TokenKind::Traceable => Ok("traceable".to_string()),
            TokenKind::Coupling => Ok("coupling".to_string()),
