...
fn get_builtin_return_type(name: &str) -> Type {
    match name {
        ...
        "sin" | "cos" | "sqrt" | "tan" | "fabs" | "pow" | "end_stress_report_p50" | "end_stress_report_p99" | "end_stress_report_rps" => Type::F64,
        "malloc" => Type::Pointer(Box::new(Type::Void)),
        "atomic_add" | "atomic_sub" | "atomic_load" => Type::I64,
        "end_channel_recv" | "end_sqlite_query" | "end_pg_query" | "end_pg_query_params" | "end_net_tcp_recv" | "end_http2_client_request" | "end_http2_mux_open_stream" | "end_http2_hpack_encode" | "end_http2_hpack_decode" | "end_http2_server_url" | "end_raft_cluster_write" | "end_raft_cluster_read" | "end_raft_cluster_read_node" | "end_raft_cluster_node_status" | "end_profiler_stop" | "end_profiler_flamegraph" | "end_stress_run" => Type::Str,
