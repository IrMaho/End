...
pub fn match_keyword_or_ident(ident: &str) -> TokenKind {
    match ident {
                    ...
                    "view" => TokenKind::View,
                    "lens" => TokenKind::Lens,
                    "agent_scope" => TokenKind::AgentScope,
                    ...
                    "intercept" => TokenKind::Intercept,
                    "hook" => TokenKind::Hook,
                    "enable" => TokenKind::Enable,
                    "disable" => TokenKind::Disable,
                    "feature_switch" => TokenKind::FeatureSwitch,
                    "traitify" => TokenKind::Traitify,
                    "equip" => TokenKind::Equip,
                    "fuse" => TokenKind::Fuse,
                    ...
                    // Event & Reactive Graph Keywords
                    "once" => TokenKind::Once,
                    "every" => TokenKind::Every,
                    "state" => TokenKind::State,
                    "derive" => TokenKind::Derive,
                    "topology" => TokenKind::Topology,
                    "debounce" => TokenKind::Debounce,
                    "throttle" => TokenKind::Throttle,
                    "sample" => TokenKind::Sample,
                    "coalesce" => TokenKind::Coalesce,
                    "window" => TokenKind::Window,
                    "ack" => TokenKind::Ack,
                    "require_ack" => TokenKind::RequireAck,
                    "replayable" => TokenKind::Replayable,
                    "durable" => TokenKind::Durable,
                    "event_sourced" => TokenKind::EventSourced,
                    "event_transaction" => TokenKind::EventTransaction,
                    ...
                    "retry_policy" => TokenKind::RetryPolicy,
