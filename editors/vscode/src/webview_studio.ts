...
export class EndStudioPanel {
  public static currentPanel: EndStudioPanel | undefined;
  public static readonly viewType = 'endStudioPanel';
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    const panel = vscode.window.createWebviewPanel(
      EndStudioPanel.viewType,
      '👑 End Visual Studio & Simulation Sandbox',
